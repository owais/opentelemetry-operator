...
Standalone mode needs RBAC for ConfigMaps and configured workload types. The repository includes a starter manifest at [`config/standalone-bridge/rbac.yaml`](../../config/standalone-bridge/rbac.yaml).
